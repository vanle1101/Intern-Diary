...
export default function InternshipApp({ view }: { view: View }) {
  ...
  return <div className="app-shell"><aside className={menu ? "sidebar open" : "sidebar"}>
    <Link className="brand ueh-sidebar-logo locked-art" href="/" onContextMenu={e => e.preventDefault()}><img src="/ueh-wordmark.png" alt="UEH University" draggable={false} /></Link>
